...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-b9t-dms.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-b9t-dms.containers.anotherwebservice.com/
...
```
git clone git@github.com:AbyNotMe/container-b9t-dms.git
cd container-b9t-dms
```
...
```
docker attach container-b9t-dms
```
